...
namespace KxLib.Utilities {
    public class FileHelper {
        #region 写文件
        public static void SaveTxt(string FilePath, string Content) {
        ...
        #region 读文件
        public static string LoadTxt(string FilePath) {
            ...
            try {
                using (FileStream stream = new FileStream(filePath, FileMode.Open, FileAccess.Read)) {
                    ...
                    if (fileLength <= BLOCK_SIZE) {
                        ...
                        byte[] sha1Buffer = StringHelper.sha1(readBuffer);
                        ...
                        byte[] sha1AllBufferSha1 = StringHelper.sha1(sha1AllBuffer);
